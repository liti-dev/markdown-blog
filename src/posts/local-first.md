...
description: Apps that work offline, keep your data private, and sync when you're ready.
date: '2025-09-27'
categories:
  - sustainability
  - local-first
...
And then there's [VSCarbon](/category/vscode). Here, I didn't want to intrude. No pre-commit hooks, no GitHub authentication, just a tool that works quietly, without asking for more than it needs.

All these threads naturally point me toward the next quest: [local-first apps](https://lofi.so/).
