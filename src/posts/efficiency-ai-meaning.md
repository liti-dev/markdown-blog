...
description: Reflections on balancing efficiency with meaningful work in the age of AI.
date: '2025-10-30'
categories:
  - sustainability
published: true
...
The same applies to the companies I want to join. I skip those that don't resonate with my values, especially the ones forcing AI buzzwords into their products just to sound innovative.
...
Recently, I came across a company providing platform to train robot brains through VLA models. This is the kind of problem where AI genuinely shines. As I understand it, their platform helps robots learn faster through simulation, feedback loops, and continuous improvement. They abstract away the infrastructure complexity so people can focus on real-world behavior and creativity. That's when AI feels meaningful to me.

Another concern with using AI is its environmental footprint. Data centers consume massive amounts of water and energy. However, when compared to training robots in physical environments and wasting materials, virtual simulation still feels like the more sustainable path. And if it makes complex technology more accessible, that's a win-win.
